...
import its.lp2.admin.main.LoginActivity;
import its.lp2.admin.main.R;
import its.lp2.admin.support.JSONParser;

public class RegisterDoctor extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner1 = (Spinner) findViewById(R.id.spDgender);
        ...
        username = (EditText)findViewById(R.id.tbDUsername);
        password = (EditText)findViewById(R.id.tbDPassword);
        email = (EditText)findViewById(R.id.tbDEmail);
        name = (EditText)findViewById(R.id.tbDname);
        birthday = (EditText)findViewById(R.id.tbDBirthday);
        bio = (EditText)findViewById(R.id.tbDAddress);
        website = (EditText)findViewById(R.id.tbDWeb);
        address = (EditText)findViewById(R.id.tbDAddress);
        phone = (EditText)findViewById(R.id.tbDPhone);
